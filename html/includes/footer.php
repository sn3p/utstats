  ...
  <footer>
    ...
    &copy; <?php echo date("Y"); ?> azazel, AnthraX, toa, <a href="https://github.com/elsheepo" rel="noopener noreferrer" target="_blank" style="margin-left:0">elsheepo</a> and sn3p
    </div>
  </footer>
